...
// Ukuran foto: tinggi tetap per row, lebar bervariasi
// Di mobile lebih kecil, di desktop lebih besar
const getSizeStyle = (index, isMobile) => {
  const variants = [
    { ratio: 1 }, // persegi
    { ratio: 1.5 }, // landscape lebar
    { ratio: 0.75 }, // portrait
    { ratio: 1.25 }, // landscape sedang
    { ratio: 1 }, // persegi
    { ratio: 1.75 }, // landscape sangat lebar
    { ratio: 0.85 }, // portrait tipis
  ];
  ...
  return (
    <div className="overflow-hidden">
      <div
        ...
        style={{ gap: isMobile ? "8px" : "12px", willChange: "transform" }}
      >
...
function UploadButton({ onUpload }) {
  return (
    <label
      className="fixed bottom-8 right-4 z-40 flex items-center gap-2 cursor-pointer rounded-full text-white/50 hover:text-white/80 transition-colors duration-200"
      style={{
...
export default function Gallery() {
  ...
  return (
    <div
      ...
      style={{ background: "#0a0a0a", marginTop: "80px" }}
    >
      ...
      <header className="relative px-5 sm:px-10 md:px-16 pb-4 sm:pb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1 sm:gap-0">
          ...
          >
            {photos.length} FOTO&nbsp;&nbsp;·&nbsp;&nbsp;KLIK UNTUK MEMBUKA
            PENUH
          </p>
        </div>
      </header>
