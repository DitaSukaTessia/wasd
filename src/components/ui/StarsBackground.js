  ...
  return (
    <div className="stars-container">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 20% 80%, rgba(26,10,62,0.8) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(7,7,32,0.9) 0%, transparent 60%), radial-gradient(ellipse at center, #0a0a2e 0%, #02020f 100%)",
        }}
      />
